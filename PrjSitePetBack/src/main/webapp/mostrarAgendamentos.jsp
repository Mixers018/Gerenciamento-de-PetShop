...
<body>
	...
	<c:if test="${not empty cancelarAgenda }">
	    	<div class="alert alert-success alert-dismissible fade show" role="alert" style="width:  40%; float: right; margin: 10px 20px" id="FadeIn">
			 <span><c:out value="${cancelarAgenda }"/></span>
			 <button type="button" class="close" data-dismiss="alert" aria-label="Close">
			    <span aria-hidden="true">&times;</span>
			  </button>
			</div>
	    </c:if>
	     <!--Controler de informação do cancelamento do serviço p/ o cliente-->
        	...
        	<div class="modal-dialog" role="document">
            	<div class="modal-content">
                	<div class="modal-header" style="width: 100%">
                		<h5 class="modal-title" id="TituloModalCentralizado" style="margin-left:8rem">Cancelar agendamento:</h5>
        				<button type="button" class="close" data-dismiss="modal" aria-label="Fechar">
	          				<span aria-hidden="true">&times;</span>
        				</button>
                    </div>
                    <div class="modal-body">
                    	<label for="inputPassword" class="col-form-label" style="margin-top:1rem">Deseja realmente cancelar o serviço agendado?</label>
                    </div>
                    <div class="modal-footer">
                    	<form action="controller.do" method="post">
                    		<input type="hidden" name="idAgendamento" id="idAgendamento"/>
                    		<button type="submit" class="btn btn-primary" name="command" value="ExcluirAgendamento">Sim</button>
			...
			<div class="conteiner">
				...
				<div class="content"  style="padding: 15px; padding-top:50px; padding-bottom:70px">
					...
					<div class="mb-4 mt-4 mr-4" style="background:white">
						<h5 class="d-flex justify-content" style=" text-transform: capitalize;font-size: 28px; color:#464747; font-weight: 400; padding-bottom:10px">Seus agendamentos</h5>
					</div>
					...
					<table class="table table-hover" style="text-align: center"> 
						...
						<tbody>
							...
							<c:forEach var="ag" items="${lstAgenda }">
								...
								<tr>
									...
									<td>${ag.hora }</td>
									<td>
										<fmt:formatDate pattern="dd/MM/yyyy" value="${ag.data }" />
									</td>
									<td>
										<fmt:setLocale value="pt-BR" />
										<fmt:formatNumber value="${ag.valor}" minFractionDigits="2" type="currency" />          
									</td>
									<td>
										<button onclick="setaDadosModal('${ag.id}')" type="button" class="btn btn-outline" data-toggle="modal" data-target="#delete-modal">&times;</button>
									</td>							
								</tr>	
							</c:forEach>
						</tbody>
